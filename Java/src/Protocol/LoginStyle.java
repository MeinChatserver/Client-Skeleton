...
public class LoginStyle implements IPacket {
    ...
    public LoginStyle(
    	@JsonProperty("background") Protocol.Color background,
    	@JsonProperty("foreground") Protocol.Color foreground,
    	@JsonProperty("backgroundList") Protocol.Color backgroundList,
    	@JsonProperty("foregroundList") Protocol.Color foregroundList,
    	@JsonProperty("backgroundImage") Protocol.Image backgroundImage
    ) {
